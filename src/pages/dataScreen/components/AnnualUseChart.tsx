...
import styles from "./AnnualUseChart.module.scss";
      ...
      formatter: (p: any) => {
        ...
        p.forEach((val: any) => {
          ...
          <div class={${styles}['year-item']}>
            <span class={styles['year-dot']}> style="background-color: ${
              val.color
            };"></span>
            <span class={${styles}['year-name']}>${val.seriesName}</span>
            <span class={${styles}['year-value']}>${
        ...
        const dom = `  
                    <div class={${styles}['annual-tooTip']}>
                      <span class={${styles}['annual-month']}>${
          p[0].dataIndex + 1
        }月</span>
                      <div  class={${styles}['annual-list']}>
                        ${str}
                      </div>
                    </div>
                  `;
